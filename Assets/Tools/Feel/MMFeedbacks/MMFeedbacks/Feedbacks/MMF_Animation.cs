...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Animation : MMF_Feedback
    {
        ...
        public override float FeedbackDuration { get => ApplyTimeMultiplier(DeclaredDuration); set => DeclaredDuration = value; }
        ...
        public override Color FeedbackColor
        {
            get
            {
                return MMFeedbacksInspectorColors.AnimationColor;
            }
        }

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ShaderGlobal : MMF_Feedback
    {
        public enum Modes
        {
            SetGlobalColor, SetGlobalFloat, SetGlobalInt, SetGlobalMatrix, SetGlobalTexture, SetGlobalVector, EnableKeyword, DisableKeyword,
            WarmupAllShaders,
        }
        ...
        [MMFEnumCondition("Mode", (int)Modes.SetGlobalColor, (int)Modes.SetGlobalFloat, (int)Modes.SetGlobalInt, (int)Modes.SetGlobalMatrix,
            (int)Modes.SetGlobalTexture, (int)Modes.SetGlobalVector)]
        ...
        public override Color FeedbackColor
        {
            get
            {
                return MMFeedbacksInspectorColors.RendererColor;
            }
        }

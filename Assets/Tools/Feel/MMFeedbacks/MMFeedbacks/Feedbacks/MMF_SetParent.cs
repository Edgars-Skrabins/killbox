...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SetParent : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => ObjectToParent != null ? ObjectToParent.name : "";
        public override string RequiresSetupText => "This feedback requires an ObjectToParent, that will be reparented to NewParent";
#endif
    }
}
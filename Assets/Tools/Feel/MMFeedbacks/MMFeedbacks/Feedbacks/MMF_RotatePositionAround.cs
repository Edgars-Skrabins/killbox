...
{
	/// <summary>
	///     This feedback will animate the target's position (not its rotation), on an arc around the specified rotation
	///     center, for the specified duration (in seconds).
	/// </summary>
	[AddComponentMenu("")]
    [FeedbackHelp(
    ...
    public class MMF_RotatePositionAround : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            if (Active || Owner.AutoPlayOnEnable)
            {
                ...
                ClearCoroutine();
                _coroutine = Owner.StartCoroutine(AnimateRotation(AnimateRotationTarget, Vector3.zero, FeedbackDuration, AnimateRotationX,
                    AnimateRotationY, AnimateRotationZ, RemapCurveZero * intensityMultiplier, RemapCurveOne * intensityMultiplier));
            }
        }
        ...
        /// <returns></returns>
        protected virtual IEnumerator AnimateRotation(
        ...
        protected virtual void ApplyRotation(
            Transform targetTransform, float remapZero, float remapOne, AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ,
            float percent)
        {
            ...
            targetTransform.position =
                MMMaths.RotatePointAroundPivot(targetTransform.position, AnimateRotationCenter.position, _rotationAngles);
        }
        ...
        public override Color FeedbackColor
        {
            get
            {
                return MMFeedbacksInspectorColors.TransformColor;
            }
        }
        ...
        public override string RequiredTargetText =>
            AnimateRotationTarget != null || AnimateRotationCenter != null ? AnimateRotationTarget.name : "";

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_CameraZoom : MMF_Feedback
    {
        ...
        public override float FeedbackDuration { get => ApplyTimeMultiplier(ZoomDuration); set => ZoomDuration = value; }
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData,
                ComputedTimescaleMode == TimescaleModes.Unscaled, false, RelativeFieldOfView);
        }
        ...
        protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
        {
            ...
            MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData,
                ComputedTimescaleMode == TimescaleModes.Unscaled, true);
        }
        ...
        protected override void CustomRestoreInitialValues()
        {
            ...
            MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData,
                ComputedTimescaleMode == TimescaleModes.Unscaled, restore: true);
        }
        ...
        public override Color FeedbackColor
        {
            get
            {
                return MMFeedbacksInspectorColors.CameraColor;
            }
        }

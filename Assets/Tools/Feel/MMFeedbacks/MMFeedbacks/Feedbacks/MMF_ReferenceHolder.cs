...
{
	/// <summary>
	///     This feedback allows you to hold a reference, that can then be used by other feedbacks to automatically set their
	///     target.
    ...
    public class MMF_ReferenceHolder : MMF_Feedback
    {
        ...
        public override Color FeedbackColor
        {
            get
            {
                return MMFeedbacksInspectorColors.FeedbacksColor;
            }
        }
